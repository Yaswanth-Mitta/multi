...
if __name__ == '__main__':
    ...
    print(f"🌍 External access: http://{ec2_ip}:{port}")
    print(f"🏠 Local access: http://localhost:{port}")
    print("\n📋 API Endpoints:")
    print(f"   • Status: http://{ec2_ip}:{port}/status")
    print(f"   • Analyze: http://{ec2_ip}:{port}/analyze")
    print("\n⚠️  Ensure EC2 Security Group allows inbound traffic on port 8000")
    print("=" * 50)
